...
public class Intlist{
    ...
    /** return a new list with every element increment  by k */
    public static Intlist incrList(Intlist l, int k){
        if (l.rest == null)
            return new Intlist(l.first + k, null);
        else
            return new Intlist(l.first + k, incrList(l.rest, k));
    }

    // /** return a new list point to l with every element increment by k */
    ...
    public static void main(String[] args){
        ...
        Intlist t =  Intlist.incrList(L, 1);
