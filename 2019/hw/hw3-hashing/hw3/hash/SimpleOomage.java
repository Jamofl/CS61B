...
public class SimpleOomage implements Oomage {
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            //return (int) ((Math.pow(red / 5, 3) * 3 * 3 * 3 + Math.pow(green / 5, 2) * 3 * 3 + (blue/ 5) * 3));
//            return (int) (Math.pow(red / 5, 3) + Math.pow(green / 5, 2) + blue / 5);
            return (int) (Math.pow(red, 3) + Math.pow(green, 2) + blue);
            //return 0;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        SimpleOomage o = new SimpleOomage(5,10,15);
